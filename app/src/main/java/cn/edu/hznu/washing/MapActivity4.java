...
public class MapActivity4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mapping4);
//获取地图控件引用
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent b1=new Intent(MapActivity4.this,MainActivity.class);
                startActivity(b1); }
        });
...
//开启地图的定位图层
        ...
        LatLng ll = new LatLng(30.296784,120.026442);
